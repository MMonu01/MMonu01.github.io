      ...
      <div id="projectBox" className={styles.projects}>
        <RevealWrapper origin="bottom" reset={false} delay={100} duration={1000} distance="300px">
          ...
          <span className={styles.slider}>
            ...
            {show4 ? <FontAwesomeIcon className={styles.colored} icon={faCircleDot} /> : <FontAwesomeIcon id="third" onClick={HandleFourth} className={styles.first} icon={faCircle} />}
          </span>
        </RevealWrapper>
      </div>
        ...
        <div className={`${styles.child} ${styles.child1}`}>
          <div class={styles.laptop}>
            <RevealWrapper rotate={{ x: 150, y: 130, z: 80 }} origin="left" delay={100} duration={1200} distance="500px" reset={false}>
              <img src="../../parallaxai.jpg" style={{ width: "100%", border: "none", height: "100%" }} alt="Parallaxai" />
            </RevealWrapper>
          </div>

          <div className={styles.box}>
            <RevealWrapper origin="right" delay={100} duration={1200} distance="500px" reset={false}>
              <h1 className={styles.head}>Parallax AI </h1>
            </RevealWrapper>

            <div className={styles.content}>
              <RevealList origin="right" delay={100} interval={60} duration={1000} distance="500px" reset={false}>
                <p className={styles.intro}>Parallax AI is a chatbot that can answer any question asked.</p>

                <p className={styles.feature}>
                  <span>Feature:</span> <span>Login/Logout | create new chat | save chats | Search previous chats | Get text answer to any of your questions | See your profile | Start chat without login </span>
                </p>
                ...
                <div class={styles.alignbtn}>
                  ...
                  <a href="https://parallaxai-iq.cyclic.app/" className={styles.btn} alt="Parallax AI website">
                    <FontAwesomeIcon icon={faLifeRing} /> Live Site
                  </a>
                </div>
              </RevealList>
            </div>
        ...
        <div className={`${styles.child} ${styles.child2}`}>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.feature}>
                <span>Feature:</span> <span>Signup/Login/Logout | Search engine | Sorting | Filtering | Pagination | Cart functionality | Payment functionality | Add new product | Update/Delete existing product | Order Handling</span>
              </p>

              <p className={styles.feature}>
                <span>Tech Stacks:</span> <span>HTML | CSS | JavaScript | React | Redux | Chakra ui | ExpressJs | NodeJs | MongoDB</span>
              </p>

              <div class={styles.alignbtn}>
                <a href="https://github.com/Rii-C/stupendous-laborer-3507" className={styles.btn} alt="Vigor Wizard github">
                  <FontAwesomeIcon icon={faGithub} /> Github
                </a>
        ...
        <div className={`${styles.child} ${styles.child2}`}>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.feature}>
                <span>Feature:</span> <span>Signup | Login | Logout | Sorting | Pagination | Cart functionality | Place order | customer details | track order</span>
              </p>

              <p className={styles.feature}>
                <span>Tech Stacks:</span> <span>HTML | CSS | JavaScript | React | JSON server</span>
              </p>

              <div class={styles.alignbtn}>
                <a href="https://github.com/MMonu01/bloommedplus" className={styles.btn} alt="bloommedplus github">
                  <FontAwesomeIcon icon={faGithub} /> Github
                </a>
        ...
        <div className={`${styles.child} ${styles.child3}`}>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.feature}>
                <span>Feature:</span> <span>Signup | Login | Users database in local storage</span>
              </p>

              <p className={styles.feature}>
                <span>Tech Stacks:</span> <span>HTML | CSS | JavaScript</span>
              </p>

              <div class={styles.alignbtn}>
                <a href="https://github.com/MMonu01/lumen5-clone" className={styles.btn} alt="Lumen5 github">
                  <FontAwesomeIcon icon={faGithub} /> Github
                </a>
