...
const Github = ()=>{
    ...
    return (
        <div className={styles.container}>
            ...
            <RevealWrapper  origin='bottom' delay={100} duration={1200} distance='100px' >
        ...
        <RevealWrapper   delay={100} duration={1200} scale={0} reset={true}>
                  <GitHubCalendar username="mmonu01"  style={{color:"white"}} blockSize={16} fontSize={16} />
                  </RevealWrapper>
        </div>
                  <div style={{marginTop:"50px"}} className={styles.box}>
                    
                  <RevealWrapper  origin='bottom' delay={300} duration={1200} distance='100px' >
